...
class CampaignHelper
{
    ...
    public static function extractTemplateUrls(string $content): array
    {
        ...
        $urls[$hash] = array_unique(array_map(['CHtml', 'decode'], array_map('trim', $matches[self::MATCH_HREFS_REGEX_URL_INDEX])));
     ...
     * @throws CException
     */
    public static function parseCountdownTag(string $content, Campaign $campaign, ?ListSubscriber $subscriber = null): string
    {

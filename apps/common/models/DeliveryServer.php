...
class DeliveryServer extends ActiveRecord
{
    ...
    const TRANSPORT_SMTP_GREENARROW = 'smtp-greenarrow';
    ...
    const TRANSPORT_BREVO_WEB_API = 'brevo-web-api';
     ...
     */
    const USE_FOR_ALL = 1;
    const USE_FOR_TRANSACTIONAL = 2;
    const USE_FOR_CAMPAIGNS = 4;
    const USE_FOR_EMAIL_TESTS = 8;
    const USE_FOR_REPORTS = 16;
    const USE_FOR_LIST_EMAILS = 32;
    const USE_FOR_INVOICES = 64;
    ...
    const FORCE_FROM_NAME_ALWAYS = 'always';
    const FORCE_FROM_NAME_NEVER = 'never';
    ...
    {
        trigger_error(sprintf('The method %s is deprecated, use %s::send instead!', __METHOD__, __CLASS__), E_USER_DEPRECATED);

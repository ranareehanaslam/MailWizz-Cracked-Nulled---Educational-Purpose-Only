...
class CampaignOption extends ActiveRecord
{
    ...
    {
        $rules = [
            ['url_tracking, open_tracking, open_tracking_from_url_tracking, open_tracking_exclude_crawlers, url_tracking_exclude_crawlers, json_feed, xml_feed, embed_images, plain_text_email', 'required'],
            ['url_tracking, open_tracking, open_tracking_from_url_tracking, open_tracking_exclude_crawlers, url_tracking_exclude_crawlers, json_feed, xml_feed, embed_images, plain_text_email', 'length', 'max' => 3],
            ['url_tracking, open_tracking, open_tracking_from_url_tracking, open_tracking_exclude_crawlers, url_tracking_exclude_crawlers, json_feed, xml_feed, embed_images, plain_text_email', 'in', 'range' => array_keys($this->getYesNoOptions())],

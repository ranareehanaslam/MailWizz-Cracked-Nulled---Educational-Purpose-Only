...
class FrontendSystemInit extends CApplicationComponent
{
    ...
    public function _registerStyles(CList $styles)
    {
        $styles->mergeWith([
            ...
            ['src' => apps()->getBaseUrl('assets/css/font-awesome/css/font-awesome.min.css'), 'priority' => -1000],
            ['src' => apps()->getBaseUrl('assets/css/ionicons/css/ionicons.min.css'), 'priority' => -1000],
